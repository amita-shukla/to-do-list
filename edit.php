...
<tr><td>Task Name: </td><td><input type="text" name="Task_Name" value="<?php echo $_GET['Task_Name'];?>" size="50" id="Task_Name"></td></tr>
...
<tr><td colspan="2"> <input type="submit" value="Edit Task"></td></tr>
</table>
</form>
