...
<?php
	if(isset($_POST['category']))
		...
		if($category=="All")
		{
			$query="SELECT Task_Name, Due_Date, Priority, Details, Completed FROM tasks WHERE id='$_SESSION[id]' ORDER BY Due_Date" or die("error".mysqli_error($link));;
		}
		else{
		$query="SELECT Task_Name, Due_Date, Priority, Details, Completed FROM tasks WHERE id='$_SESSION[id]' AND Category='$category' ORDER BY Due_Date" or die("error".mysqli_error($link));
		}
		}
	else
